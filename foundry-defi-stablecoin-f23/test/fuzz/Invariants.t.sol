...
/**
 * 1. The total supply of DSC (esentially the debt) should be less than the total value of collateral
 * 2. Getter view fns should never revert <- evergreen invariant
 * This enough for now.
 */
...
contract Invariants is StdInvariant, Test {
    ...
    function setUp() external {
        ...
        // targetContract(address(dsce)); // telling foundry to go wild on this
